...
describe("admin email authorization", () => {
  ...
  it("includes the official contact for notifications without removing configured admins", () => {
    process.env.ADMIN_EMAIL =
      "tiagodearaujo13@gmail.com,russatatuadora@gmail.com";

    assert.deepEqual(
      getAdminNotificationEmails("russatatuadora@gmail.com"),
      ["tiagodearaujo13@gmail.com", "russatatuadora@gmail.com"]
    );
  });

  it("adds the official contact when it is not an authorized admin", () => {
